...
if __name__ == "__main__":
    cfg_env_list = read_dir("./src/configs/predictors_rb/cfg_env")
    cfg_agt_list = read_dir("./src/configs/predictors_rb/cfg_agent")
    cfg_mdl_list = read_dir("./src/configs/predictors_rb/cfg_model")
    ...
    import json
    with open(f"./outputs/predictors/1001_rb.json", "w") as f:
        json.dump(res, f)
