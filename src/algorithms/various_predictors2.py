...
if __name__ == "__main__":
    cfg_env_list = read_dir("./src/configs/predictors_ratio/cfg_env")
    cfg_agt_list = read_dir("./src/configs/predictors_ratio/cfg_agent")
    cfg_mdl_list = read_dir("./src/configs/predictors_ratio/cfg_model")
    ...
    import json
    with open(f"./outputs/predictors/1006.json", "w") as f:
        json.dump(res, f)
