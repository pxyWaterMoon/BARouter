...
class Carrot2(OnlineModel):
    def __init__(self, rmodel:BasePredictor, cmodel:BasePredictor, logger:Logger, T, budget, embedding_fn, mu):
        self.budget = budget
        self.rmodel = rmodel
        self.cmodel = cmodel
        self.mu = mu
    ...
    def take_action(self, sample):
        ...
        weight = (1-self.mu)*predict_reward - (self.mu)*predict_cost/10 # (K)
